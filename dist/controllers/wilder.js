...
exports.default = {
    create: async (req, res) => {
        ...
        await wilder_1.default.init().then(() => {
    ...
    getOne: async (req, res) => {
        ...
        await wilder_1.default.findOne({ _id })
            .then((result) => {
            if (!result) {
                return res.json({
                    success: false,
    ...
    update: async (req, res) => {
        const { name, city, description, skills } = req.body;
        const { _id } = req.params;
        await wilder_1.default.updateOne({ _id }, {
            name: name,
            city: city,
            description,
            skills: skills,
    ...
    delete: async (req, res) => {
        const { _id } = req.params;
        await wilder_1.default.deleteOne({ _id })
            .then((result) => {
